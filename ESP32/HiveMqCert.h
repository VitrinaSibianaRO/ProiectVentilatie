...
// ISRG Root X1 în format PEM — folosit de WiFiClientSecure pe calea WiFi.
// Același CA care semnează certificatele HiveMQ Cloud (via Let's Encrypt).
// Expiră 4 Iun 2035.
static const char ISRG_ROOT_X1_PEM[] PROGMEM = R"EOF(
-----BEGIN CERTIFICATE-----
